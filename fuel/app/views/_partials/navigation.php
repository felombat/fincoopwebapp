            ...
            <ul class="nav metismenu" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level collapse" style="">
                        <li><a href="<?= Uri::create('finances/contributions') ;?>">Contributions</a></li>
                        <li><a href="<?= Uri::create('finances/expenses') ;?>">Expenses</a></li>
                        <li><a href="<?= Uri::create('finances/report') ;?>">Contr. Vs Exp.</a></li>
                         
                    </ul>
                 </li>

                  <li>
                    <a href="#"><i class="fa fa-building"></i> <span class="nav-label">BANK</span><span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level collapse" style="">
                        <li><a href="<?= Uri::create('bank/account') ;?>">Account</a></li>
                        <li><a href="<?= Uri::create('finances/transferts') ;?>">Transerts</a></li>
                        <li><a href="<?= Uri::create('finances/transactions') ;?>">Transactions</a></li>
